...
function [AUCTest,PCCTest,BSTest,KSTest,PGITest,RelmissClassifCost,EconomicIndicators] = ...
                 computeEvalCriteriaCS(depTest,predictProbTest,predictClassTest,missClassLogistic)
...
RelmissClassifCost=100*((missClassLogistic-missClassifCost)./missClassLogistic);
